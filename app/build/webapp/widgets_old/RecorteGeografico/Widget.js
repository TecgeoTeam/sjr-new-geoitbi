      ...
      // Custom widget code goes here
        ...
        searchByPointList: function(pointList, callback) {
          ...
          if (option.indexOf('Setor') !== -1) {
            serviceUrl = 'http://www.senocwb.com/senoportal/rest/services/sjr_desenvolvimento/SJR_infraestrutura_Geo/MapServer/11';
          } else if (option.indexOf('Bairro') !== -1) {
            serviceUrl = 'http://www.senocwb.com/senoportal/rest/services/sjr_desenvolvimento/SJR_infraestrutura_Geo/MapServer/12';
          }

          if (option.indexOf('Quadra') !== -1) {
            let features = [];
            this.searchServiceByPointList('http://www.senocwb.com/senoportal/rest/services/sjr_desenvolvimento/SJR_infraestrutura_Geo/MapServer/22', pointList, function(result) {
              for (let i = 0; i < result.length; i++) {
                features.push(result[i]);
              }
              selfRecorte.searchServiceByPointList('http://www.senocwb.com/senoportal/rest/services/sjr_desenvolvimento/SJR_infraestrutura_Geo/MapServer/21', pointList, function(result) {
                for (let i = 0; i < result.length; i++) {
                  features.push(result[i]);
                }
          ...
          if (option.indexOf('Lote') !== -1) {
            let features = [];
            this.searchServiceByPointList('http://www.senocwb.com/senoportal/rest/services/sjr_desenvolvimento/SJR_infraestrutura_Geo/MapServer/14', pointList, function(result) {
              for (let i = 0; i < result.length; i++) {
                features.push(result[i]);
              }
              selfRecorte.searchServiceByPointList('http://www.senocwb.com/senoportal/rest/services/sjr_desenvolvimento/SJR_infraestrutura_Geo/MapServer/15', pointList, function(result) {
                for (let i = 0; i < result.length; i++) {
                  features.push(result[i]);
                }
                callback(null, features);
        ...
        getPesquisasInDraw: function(evt, dataInicio, dataFim, callback) {
          ...
          let serviceUrl = 'http://www.senocwb.com/senoportal/rest/services/SJR_ITBI/Mapas_Tematicos_das_Pesquisas/MapServer/0';
          ...
          let data = {
            ...
            'whereUnidade': whereUnidade
             ...
             var settings = {
                "async": true,
                "crossDomain": true,
                "url": "http://93.188.166.2:1010/transmissaounidade",
                "method": "POST",
                "headers": {
        ...
        searchSetor: function(setores, callback) {
          let serviceUrlFiltro = 'http://www.senocwb.com/senoportal/rest/services/sjr_desenvolvimento/SJR_infraestrutura_Geo/MapServer/11';
          let query = new Query();
        ...
        searchBairro: function(bairroString, callback) {
          let serviceUrlFiltro = 'http://www.senocwb.com/senoportal/rest/services/sjr_desenvolvimento/SJR_infraestrutura_Geo/MapServer/12';
          let query = new Query();
          let queryTask = new QueryTask(serviceUrlFiltro);
        ...
        searchQuadraNaoRecadastrada: function(quadras, callback) {
          let serviceUrlFiltro = 'http://www.senocwb.com/senoportal/rest/services/sjr_desenvolvimento/SJR_infraestrutura_Geo/MapServer/22';
          let query = new Query();
          let queryTask = new QueryTask(serviceUrlFiltro);
          query.returnGeometry = true;
        ...
        searchQuadraRecadastrada: function(quadras, callback) {
          let serviceUrlFiltro = 'http://www.senocwb.com/senoportal/rest/services/sjr_desenvolvimento/SJR_infraestrutura_Geo/MapServer/21';
          let query = new Query();
          let queryTask = new QueryTask(serviceUrlFiltro);
          query.returnGeometry = true;
          query.outFields = ['*'];
        ...
        searchLoteNaoRecadastrada: function(lotes, callback) {
          let serviceUrlFiltro = 'http://www.senocwb.com/senoportal/rest/services/sjr_desenvolvimento/SJR_infraestrutura_Geo/MapServer/15';
          let query = new Query();
          let queryTask = new QueryTask(serviceUrlFiltro);
          query.returnGeometry = true;
          query.outFields = ['*'];
        ...
        searchLoteRecadastrada: function(lotes, callback) {
          let serviceUrlFiltro = 'http://www.senocwb.com/senoportal/rest/services/sjr_desenvolvimento/SJR_infraestrutura_Geo/MapServer/14';
          let query = new Query();
          let queryTask = new QueryTask(serviceUrlFiltro);
          query.returnGeometry = true;
          query.outFields = ['*'];
          ...
          query.where = 'sjr_cadastro.SDE.Lote.INS_ANT IN('+ "'" + lotes + "'" + ')';
        ...
        getTransmissoesInDraw: function(evt, dataInicio, dataFim, callback) {
          ...
          selfRecorte.getLotesInDraw(evt, function(lotesResponse) {
            ...
            for (let i = 0; i < features.length; i++) {
              ...
              if (features[i].attributes['sjr_cadastro.SDE.Lote.INS_ANT']) {
                geocodeValue += '\'' + features[i].attributes['sjr_cadastro.SDE.Lote.INS_ANT'] + '\'';
              }
              ...
              if (features && features.length > 0) {
                ...
                for (let i = 0; i < features.length; i++) {
                  ...
                  for (let j = 0; j < transmissaoResponse.length; j++) {
                    ...
                    if (lote.attributes['sjr_cadastro.SDE.Lote.INS_ANT'] === transmissao.de_inscricao || lote.attributes['sjr_cadastro.SDE.Lote_Nao_Prioritario_v04.GEOCODE'] === transmissao.de_inscricao) {
                  ...
                  for (let j = 0; j < transmissaoResponse.length; j++) {
                    ...
                    for (let k = 0; k < lotesComTransmissoesSelecionadas.length; k++) {
                      if (lotesComTransmissoesSelecionadas[k].attributes['sjr_cadastro.SDE.Lote.INS_ANT'] === transmissao.de_inscricao || lotesComTransmissoesSelecionadas[k].attributes['sjr_cadastro.SDE.Lote_Nao_Prioritario_v04.GEOCODE'] === transmissao.de_inscricao) {
                        hasLote = true;
                      }
                    }
                    if (!hasLote) {
        ...
        getLotesContempladosInDraw: function(evt, callback) {
          let serviceUrl = 'http://www.senocwb.com/senoportal/rest/services/sjr_desenvolvimento/SJR_infraestrutura_Geo/MapServer/14';
        ...
        getLotesNaoContempladosInDraw: function(evt, callback) {
          let serviceUrl = 'http://www.senocwb.com/senoportal/rest/services/sjr_desenvolvimento/SJR_infraestrutura_Geo/MapServer/15';
          ...
          if (transmissoes) {
            ...
            for (let i = 0; i < transmissoes.length; i++) {
              if (transmissoes[i].de_TIPO_IMOVEL === 'PREDIAL') {
                ...
                tipoImovel.valor.predial += Number(transmissoes[i].nu_vvt);
              } else {
                tipoImovel.quantidade.territorial++;
                tipoImovel.valor.territorial += Number(transmissoes[i].nu_vvt);
              }
              tipoImovel.quantidade.total++;
              tipoImovel.valor.total += Number(transmissoes[i].nu_vvt);
            }
            let dateList = [];
            for (let i = 0; i < transmissoes.length; i++) {
            ...
            for (let i = 0; i < transmissoes.length; i++) {
              if (transmissoes[i].de_TIPO_IMOVEL === 'PREDIAL' && tipoImovel.quantidade.predial > 0) {
                ...
                tipoImovelPorTempo[moment(transmissoes[i].dt_vencimento).format(dateMask)].valor.predial += Number(transmissoes[i].nu_vvt);
                ...
                tipoImovelPorTempo[moment(transmissoes[i].dt_vencimento).format(dateMask)].valor.territorial += Number(transmissoes[i].nu_vvt);
              }
              tipoImovelPorTempo[moment(transmissoes[i].dt_vencimento).format(dateMask)].quantidade.total++;
              tipoImovelPorTempo[moment(transmissoes[i].dt_vencimento).format(dateMask)].valor.total += Number(transmissoes[i].nu_vvt);
            }
            ...
            for (let i = 0; i < transmissoes.length; i++) {
              if (transmissoes[i].de_TIPOLOGIA) {
                ...
                tipologia.valor[transmissoes[i].de_TIPOLOGIA] += Number(transmissoes[i].nu_vvt);
              } else {
                tipologia.quantidade.nenhuma++;
                tipologia.valor.nenhuma += Number(transmissoes[i].nu_vvt);
              }
              tipologia.quantidade.total++;
              tipologia.valor.total += Number(transmissoes[i].nu_vvt);
            }
          }
        ...
        generateTransmissaoDatatable: function(transmissaoData) {
          ...
          if (transmissaoData) {
            for (let i = 0; i < transmissaoData.length; i++) {
              rows.data.push([transmissaoData[i].nu_idtransmissao, transmissaoData[i].de_GEOCODE_LOTE, transmissaoData[i].de_PROP_NOME, transmissaoData[i].de_TIPOLOGIA, transmissaoData[i].nu_AREA_CONSTRUIDA, moment(transmissaoData[i].dt_vencimento).format('DD/MM/YYYY'), numberParaReal(transmissaoData[i].nu_vvt)]);
            }
          }
        ...
        generateAreaPorValorDoMetroData: function(transmissoes, loteFeature, dataDe, dataPara, callback) {
          ...
          for (let i = 0; i < latestTransmissao.length; i++) {
            let area;
            let valorPorMetro;
            let valor = Number(latestTransmissao[i].nu_vvt.replace(',', '.'));
          ...
          function generateBuffer(callback) {
            if (loteFeature) {
              let serviceUrl = 'http://www.senocwb.com/senoportal/rest/services/sjr_desenvolvimento/SJR_infraestrutura_Geo/MapServer/14';
              let gsv = new GeometryService('http://www.senocwb.com/senoportal/rest/services/Utilities/Geometry/GeometryServer');
              // setup the buffer parameters
            ...
            if (circleGeometry) {
              that.getTransmissoesInDraw([{geometry: circleGeometry}], dataDe, dataPara, function(transmissaoResponse) {
                ...
                for (let i = 0; i < transmissoesSimilar.length; i++) {
                  let area;
                  let valorPorMetro;
                  let valor = Number(transmissoesSimilar[i].nu_vvt.replace(',', '.'));
