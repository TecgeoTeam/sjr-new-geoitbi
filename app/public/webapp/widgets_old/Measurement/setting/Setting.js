  ...
  return declare([BaseWidgetSetting, _WidgetsInTemplateMixin], {
    ...
    setConfig: function(config) {
      ...
      this._processConfig(config).then(lang.hitch(this, function(configJson) {
        ...
        if (typeof configJson.showArea !== 'undefined' && configJson.showArea === false) {
          this.showArea.setValue(false);
        }
        if (typeof configJson.showDistance !== 'undefined' && configJson.showDistance === false) {
          this.showDistance.setValue(false);
        }
        if (typeof configJson.showLocation !== 'undefined' && configJson.showLocation === false) {
    ...
    _onShowToolItemsChange: function(obj) {
      if (obj) {
        if (obj.checked === false && this._isItemsAllHide()) {
          obj.check();
          Tooltip.hide();
