...
define([
  ...
  let clazz = declare(BaseFeatureAction, {
    ...
    onExecute: function(featureSet, layer) {
      let layerInfos = LayerInfos.getInstanceSync();
      let selectedLayerInfo = layerInfos.getLayerInfoById(layer.id);
      let selectedIds = array.map(featureSet.features, lang.hitch(this, function(f) {
