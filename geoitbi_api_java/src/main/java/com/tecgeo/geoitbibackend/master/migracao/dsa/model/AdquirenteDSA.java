...
@Entity
@Table(name="mig.TEMP_SL_CADASTRO_SDE_TB_ADQUIRENTE")
@SuppressWarnings("serial")
public class AdquirenteDSA implements Serializable {
	...
	public AdquirenteDSA() {
		// Construtor vazio Hibernate
	}

	public AdquirenteDSA(AdquirenteDestino adquirenteDestino) {
		this.setObjectId(adquirenteDestino.getObjectId());
		this.setAliquotaItbi(adquirenteDestino.getAliquotaItbi());
		this.setCpfCnpj(adquirenteDestino.getCpfCnpj());
		this.setDataSolicitacao(adquirenteDestino.getDataSolicitacao());
		this.setDataUltimaAtualizacaoMig(adquirenteDestino.getDataUltimaAtualizacaoMig());
		this.setEmiteGuiaIss(adquirenteDestino.getEmiteGuiaIss());
		this.setEmiteGuiaItbi(adquirenteDestino.getEmiteGuiaItbi());
		this.setIdCtacte(adquirenteDestino.getIdCtacte());
		this.setIdDocApagar(adquirenteDestino.getIdDocApagar());
		this.setIdImovel(adquirenteDestino.getIdImovel());
		this.setIdMunicipio(adquirenteDestino.getIdMunicipio());
		this.setIdOld(adquirenteDestino.getIdOld());
		this.setIdPessoa(adquirenteDestino.getIdPessoa());
		this.setIdPessoaSacado(adquirenteDestino.getIdPessoaSacado());
		this.setIdQrCode(adquirenteDestino.getIdQrCode());
		this.setIdTransmissao(adquirenteDestino.getIdTransmissao());
		this.setIdUnidadeCartorio(adquirenteDestino.getIdUnidadeCartorio());
		this.setIdUsuarioSolicitacao(adquirenteDestino.getIdUsuarioSolicitacao());
		this.setIncidelaudemio(adquirenteDestino.getIncidelaudemio());
		this.setMigrado(adquirenteDestino.getMigrado());
		this.setNaturezaTransmissao(adquirenteDestino.getNaturezaTransmissao());
		this.setNomePessoa(adquirenteDestino.getNomePessoa());
		this.setObservacao(adquirenteDestino.getObservacao());
		this.setParcelada(adquirenteDestino.getParcelada());
		this.setPercentualRecebido(adquirenteDestino.getPercentualRecebido());
		this.setPossuiCorretagem(adquirenteDestino.getPossuiCorretagem());
		this.setPossuiFinanciamento(adquirenteDestino.getPossuiFinanciamento());
		this.setPrimeiraTransmissao(adquirenteDestino.getPrimeiraTransmissao());
		this.setProtocolo(adquirenteDestino.getProtocolo());
		this.setSituacao(adquirenteDestino.getSituacao());
		this.setTerceiraAvaliacao(adquirenteDestino.getTerceiraAvaliacao());
		this.setValorBase(adquirenteDestino.getValorBase());
		this.setValorBaseUtilizado(adquirenteDestino.getValorBaseUtilizado());
		this.setValorItbi(adquirenteDestino.getValorItbi());
		this.setValorTransacao(adquirenteDestino.getValorTransacao());
		this.setValorVenal(adquirenteDestino.getValorVenal());
		this.setValorVenalEdificacao(adquirenteDestino.getValorVenalEdificacao());
		this.setValorVenalTerreno(adquirenteDestino.getValorVenalTerreno());
	}
