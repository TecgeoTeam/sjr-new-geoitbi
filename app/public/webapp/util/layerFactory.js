...
define([
  ...
  function createMapQuestLayer(type) {
    var layer, subdomains = ['otile1', 'otile2', 'otile3', 'otile4'],
      ext = 'png';
  ...
  layerFactory = declare([Evented], {
    ...
    createLayer: function(options) {
      var self = this,
        mapServerRe, featureLayerRe, imageServerRe, url, layerOptions = options.options || {};
      ...
      */
      function getMapNameFromUrl(url) {
        var arcgisRe = /services\/(.+)\/\w+Server/i,
          name, match;
