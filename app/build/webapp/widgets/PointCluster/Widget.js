        ...
        define([
            ...
            'dojo/domReady!'
                ...
                var url = 'http://www.senocwb.com/senoportal/rest/services/SJR_ITBI/Mapas_Tematicos_das_Pesquisas/MapServer/2';
                var outputFields = [];
         ...
         function addClusterLayer() {
            ...
            self.clusterPredial = new ClusterFeatureLayer({
                "url": "http://www.senocwb.com/senoportal/rest/services/SJR_ITBI/Mapas_Tematicos_das_Pesquisas/FeatureServer/1",
        ...
        selectedSymSobrado = new SimpleMarkerSymbol("circle", 16,
         ...
         function addClusterLayer() {
            ...
            self.clusterLayerSemInformacao = new ClusterFeatureLayer({
                "url": "http://www.senocwb.com/senoportal/rest/services/SJR_ITBI/Mapas_Tematicos_das_Pesquisas/FeatureServer/2",
                //"url": "http://services.arcgis.com/BG6nSlhZSAWtExvp/arcgis/rest/services/GlobalSeismographyNetwork/FeatureServer/0",
                // "url": "http://sampleserver3.arcgisonline.com/ArcGIS/rest/services/Earthquakes/Since_1970/MapServer/0",
                "distance": 95,
                "id": "clusters1",
