...
@Entity
@Table(name="mig.TEMP_SL_CADASTRO_SDE_TB_UNIDADES_PROP")
@SuppressWarnings("serial")
public class UnidadeDSA implements Serializable {
	...
	public UnidadeDSA(UnidadeDestino unidadeDestino) {
		this.setObjectId(unidadeDestino.getObjectId());
		this.setAgua(unidadeDestino.getAgua());
		this.setAnoPredial(unidadeDestino.getAnoPredial());
		this.setAnoTerreno(unidadeDestino.getAnoTerreno());
		this.setArborizacao(unidadeDestino.getArborizacao());
		this.setAreaConstruida(unidadeDestino.getAreaConstruida());
		this.setAreaVerde(unidadeDestino.getAreaVerde());
		this.setAreaTerreno(unidadeDestino.getAreaTerreno());
		this.setBairro(unidadeDestino.getBairro());
		this.setCalcada(unidadeDestino.getCalcada());
		this.setCalcadaPedestre(unidadeDestino.getCalcadaPedestre());
		this.setCaracValorPredial(unidadeDestino.getCaracValorPredial());
		this.setCep(unidadeDestino.getCep());
		this.setCobertura(unidadeDestino.getCobertura());
		this.setCobranca(unidadeDestino.getCobranca());
		this.setColetaLixo(unidadeDestino.getColetaLixo());
		this.setCodigoMensagem(unidadeDestino.getCodigoMensagem());
		this.setColetaLixo(unidadeDestino.getColetaLixo());
		this.setCodSqCodLog(unidadeDestino.getCodSqCodLog());
		this.setComplemento(unidadeDestino.getComplemento());
		this.setCondominio(unidadeDestino.getCondominio());
		this.setConservacao(unidadeDestino.getConservacao());
		this.setConservacaoVia(unidadeDestino.getConservacaoVia());
		this.setDataMigracao(unidadeDestino.getDataMigracao());
		this.setDestinacao(unidadeDestino.getDestinacao());
		this.setDistrito(unidadeDestino.getDistrito());
		this.setDrenagem(unidadeDestino.getDrenagem());
		this.setEdificacoes(unidadeDestino.getEdificacoes());
		this.setElevador(unidadeDestino.getElevador());
		this.setEsgoto(unidadeDestino.getEsgoto());
		this.setEsquadria(unidadeDestino.getEsquadria());
		this.setEstacionamento(unidadeDestino.getEstacionamento());
		this.setEstrutura(unidadeDestino.getEstrutura());
		this.setFachadaPrincipal(unidadeDestino.getFachadaPrincipal());
		this.setGeocodeId(unidadeDestino.getGeocodeId());
		this.setGeocodeStm(unidadeDestino.getGeocodeStm());
		this.setHidrante(unidadeDestino.getHidrante());
		this.setIdade(unidadeDestino.getIdade());
		//this.setIdImovel(unidadeDestino.getIdImovel());
		this.setIluminacao(unidadeDestino.getIluminacao());
		this.setImoValorIptu(unidadeDestino.getImoValorIptu());
		this.setImoValorPredial(unidadeDestino.getImoValorPredial());
		this.setImoValorTerritorio(unidadeDestino.getImoValorTerritorio());
		this.setImoValorVenal(unidadeDestino.getImoValorVenal());
		this.setImovelNaPlanta(unidadeDestino.getImovelNaPlanta());
		this.setInscricao(unidadeDestino.getInscricao());
		this.setInscricaoAnterior(unidadeDestino.getInscricaoAnterior());
		this.setIrregularidade(unidadeDestino.getIrregularidade());
		this.setIsento(unidadeDestino.getIsento());
		this.setLimite(unidadeDestino.getLimite());
		this.setLimpezaPublica(unidadeDestino.getLimpezaPublica());
		this.setLogradouro(unidadeDestino.getLogradouro());
		this.setLoteFiscal(unidadeDestino.getLoteFiscal());
		this.setMeiofio(unidadeDestino.getMeiofio());
		this.setNumero(unidadeDestino.getNumero());
		this.setOcupacaoDoLote(unidadeDestino.getOcupacaoDoLote());
		this.setPadraoConstrucao(unidadeDestino.getPadraoConstrucao());
		this.setPar(unidadeDestino.getPar());
		this.setPatrimonio(unidadeDestino.getPatrimonio());
		this.setPavimentacao(unidadeDestino.getPavimentacao());
		this.setPavimentos(unidadeDestino.getPavimentos());
		this.setPedologia(unidadeDestino.getPedologia());
		this.setPontoServico(unidadeDestino.getPontoServico());
		this.setPosicaoConstrucao(unidadeDestino.getPosicaoConstrucao());
		this.setPropAquisicao(unidadeDestino.getPropAquisicao());
		this.setPropBairro(unidadeDestino.getPropBairro());
		this.setPropCep(unidadeDestino.getPropCep());
		this.setPropCidade(unidadeDestino.getPropCidade());
		this.setPropComplemento(unidadeDestino.getPropComplemento());
		this.setPropCpf(unidadeDestino.getPropCpf());
		this.setPropEmail(unidadeDestino.getPropEmail());
		this.setPropEndereco(unidadeDestino.getPropEndereco());
		this.setPropFone(unidadeDestino.getPropFone());
		this.setPropNome(unidadeDestino.getPropNome());
		this.setPropNumero(unidadeDestino.getPropNumero());
		this.setPropQuadra(unidadeDestino.getPropQuadra());
		this.setPropUf(unidadeDestino.getPropUf());
		this.setQuadraFiscal(unidadeDestino.getQuadraFiscal());
		this.setRedeEletrica(unidadeDestino.getRedeEletrica());
		this.setRedeTelefonica(unidadeDestino.getRedeTelefonica());
		this.setRefCadastral(unidadeDestino.getRefCadastral());
		this.setSentido(unidadeDestino.getSentido());
		this.setSentidoLogradouro(unidadeDestino.getSentidoLogradouro());
		this.setSetor(unidadeDestino.getSetor());
		this.setSituacao(unidadeDestino.getSituacao());
		this.setSituacaoPrefeitura(unidadeDestino.getSituacaoPrefeitura());
		this.setTestadaT1(unidadeDestino.getTestadaT1());
		this.setTipoCondominio(unidadeDestino.getTipoCondominio());
		this.setTipoImovel(unidadeDestino.getTipoImovel());
		this.setTipologia(unidadeDestino.getTipologia());
		this.setTipoVia(unidadeDestino.getTipoVia());
		this.setTopografia(unidadeDestino.getTopografia());
		this.setTransporteColetivo(unidadeDestino.getTransporteColetivo());
		this.setUnidade(unidadeDestino.getUnidade());
		this.setUso(unidadeDestino.getUso());
		this.setValorTerreno(unidadeDestino.getValorTerreno());
		this.setZonaReferencia(unidadeDestino.getZonaReferencia());
	}
