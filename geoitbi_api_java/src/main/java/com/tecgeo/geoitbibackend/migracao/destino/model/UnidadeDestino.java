...
@Entity
@Table(name="sde.TB_UNIDADES_PROP")
...
public class UnidadeDestino implements Serializable {
	...
	@Column(name="ID_IMOVEL", columnDefinition="NVARCHAR(50)")
	@Getter @Setter
	...
	@Column(name="DE_REF_CADASTRAL", columnDefinition="NVARCHAR(50)")
	@Getter @Setter
	private String refCadastral;
	
	@Column(name="DE_DISTRITO", columnDefinition="NVARCHAR(50)")
	@Getter @Setter
	private String distrito;
	
	@Column(name="DE_SETOR", columnDefinition="NVARCHAR(50)")
	@Getter @Setter
	private String setor;
	
	@Column(name="DE_QUADRA_FISCAL", columnDefinition="NVARCHAR(50)")
	@Getter @Setter
	private String quadraFiscal;
	
	@Column(name="DE_LOTE_FISCAL", columnDefinition="NVARCHAR(50)")
	@Getter @Setter
	private String loteFiscal;
	
	@Column(name="DE_UNIDADE", columnDefinition="NVARCHAR(50)")
	@Getter @Setter
	private String unidade;
	
	@Column(name="NU_COD_LOGRADOURO", columnDefinition="NVARCHAR(50)")
	@Getter @Setter
	...
	@Column(name="DE_NUMERO", columnDefinition="NVARCHAR(50)")
	@Getter @Setter
	private String numero;
	
	@Column(name="DE_COMPLEMENTO", columnDefinition="NVARCHAR(120)")
	@Getter @Setter
	private String complemento;
	
	@Column(name="DE_CEP", columnDefinition="NVARCHAR(50)")
	@Getter @Setter
	private String cep;
	...
	@Column(name="DE_IDADE", columnDefinition="NVARCHAR(50)")
	@Getter @Setter
	...
	@Getter @Setter
	private BigDecimal imoValorIdeal;
	...
	@Column(name="DE_PROP_CPF", columnDefinition="NVARCHAR(50)")
	@Getter @Setter
	private String propCpf;
	
	@Column(name="DE_PROP_CIDADE", columnDefinition="NVARCHAR(60)")
	@Getter @Setter
	...
	@Column(name="DE_PROP_AQUISICAO", columnDefinition="NVARCHAR(50)")
	@Getter @Setter
	...
	@Column(name="DE_PROP_COMPLEMENTO", columnDefinition="NVARCHAR(150)")
	@Getter @Setter
	...
	@Column(name="DE_GEOCODE_LOTE", columnDefinition="NVARCHAR(50)")
	@Getter @Setter
