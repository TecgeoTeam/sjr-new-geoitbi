...
class Urls extends React.Component {
  ...
  constructor(props) {
    ...
    this.columns = [
      ...
      },
      {
        ...
        selector: 'acoes',
        sortable: false,
        cell: row => <Button variant='success' size='sm' onClick={() => this.modalPermissoes(!this.state.openModalPermissoes, row.id)}>Excluir</Button>
      },
  ...
  loadData = () => {
    ...
    /*fetch(this.config.appurl+"admin/urls/listar",{
      method: 'POST',
