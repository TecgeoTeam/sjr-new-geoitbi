...
function(
  ...
  return declare([BaseWidget], {
    ...
    filtroCadastro: function() {
      ...
      let parametro = [{
        name: 'de_username',
        value: usuarioDados.usuario.username,
        operador: 'Igual',
        label: 'Usuário'
      }];
    ...
    generateBuffer: function(evt) {
      let serviceUrl = 'https://sigribamar.com.br/server/rest/services/GeoITBI/Mapas_Tematicos_das_Pesquisas/FeatureServer/0';
    ...
    searchPesquisa: function(dataInicio, dataFim, parametrosPesquisa, callback) {
      let serviceUrlFiltro = 'https://sigribamar.com.br/server/rest/services/GeoITBI/Mapas_Tematicos_das_Pesquisas/FeatureServer/0';
      let query = new Query();
